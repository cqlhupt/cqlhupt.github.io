...
Github是著名的开源，同性交友社区，为广大用户提供了一个网上代码、博客托管空间，大约有300M空间，当然我们需要先在[github官网](www.github.com)注册一个账户，在官网上就可以注册。当你注册好了，就可以开始搭建属于你自己的Hexo博客了。
...
进入[Github官网](www.github.com)登陆你的账户，点击右上角“+”号，选择New repository，第一项是仓库名，这个仓库将用于托管我们的博客静态页面，所以命名有讲究：
```
 你的用户名.github.io
```
...
域名是为了帮助解决人们对于IP地址的记忆难题的一套机制，如[www.baidu.com](www.baidu.com)，[www.alibaba.com](www.alibaba.com)，[www.cqlh.ml](www.cqlh.ml)都是域名，而IP地址是一串点分十进制数，如14.255.177.39，106.11.223.101，185.199.108.153等，显然前面两者更好记忆，我们可以给我们的博客绑定一个属于我们自己的域名，方便大家访问。
...
前往：[www.freenom.com](www.freenom.com) 
...
```
* 回到DNSPOD__域名解析__中点击我们刚才添加的__域名__
